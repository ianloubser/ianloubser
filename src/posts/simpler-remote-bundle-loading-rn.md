...
_**Note:** This is greatly inspired by Codepush (now deprecated) and [this great article written by Sarath](https://sarathkcm.dev/blog/lazy-loading-react-native-components-from-a-server)_